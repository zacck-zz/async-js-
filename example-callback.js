...
request({url: unitUrl, json: true}, function(error, response, body ) {
  if(error) {
    ...
    console.log(`${name} weather today is ${weather} with highs of ${high} celcius and lows of ${low} celcius`)
  }
});
